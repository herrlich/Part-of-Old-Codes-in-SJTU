...
def array():
	...
	for i in range(0,1000):
		tmp_weight = random.uniform(0,20)
		switch_list.append(tmp_weight)
		switch_weight.append(tmp_weight)
	for i in range(0,1000):
		tmp_weight = random.uniform(0,5)
		switch_list.append(tmp_weight)
		switch_weight.append(tmp_weight)
	for i in range(0,1000):
		tmp_weight = random.paretovariate(3)
		...
		switch_weight.append(tmp_weight)
	for i in range(0,1000):
		tmp_weight = random.uniform(10,40)
		switch_list.append(tmp_weight)
		switch_weight.append(tmp_weight)
	for i in range(0,1000):
		tmp_weight = random.uniform(0,30)
		switch_list.append(tmp_weight)
		switch_weight.append(tmp_weight)
	for i in range(0,1000):
		tmp_weight = random.uniform(10,20)
		switch_list.append(tmp_weight)
		switch_weight.append(tmp_weight)
	for i in range(0,1000):
		tmp_weight = random.uniform(30,60)
		switch_list.append(tmp_weight)
		switch_weight.append(tmp_weight)
	for i in range(0,1000):
		tmp_weight = random.paretovariate(3)
